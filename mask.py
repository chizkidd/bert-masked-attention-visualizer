...
def visualize_attentions(tokens, attentions):
    ...
    for i in range(num_layers):
        ...
        for k in range(num_heads):
            layer_number = i + 1  # Convert to 1-indexed
            head_number = k + 1   # Convert to 1-indexed
            attention_weights = attentions[i][0][k]  # Get attention weights for current layer and head
